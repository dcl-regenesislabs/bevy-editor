...
import { setUiBuilderUndo } from '../core/history'
...
import { listUiFiles, openUiFromFile, importAvailable, canSave, saveUiToFile } from './import-tsx'
...
export function UiBuilder(): JSX.Element {
  ...
  return (
    <div className="eui-uib-root">
      <div className="eui-panel eui-uib-left">
...
function GenerateModal(props: { onClose: () => void }): JSX.Element {
  ...
  return (
    <Modal
      title={`Generated component — ${componentName}.tsx`}
      size="lg"
