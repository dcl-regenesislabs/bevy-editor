...
// First line of every runtime-module master. The refresh pass only ever
// overwrites a file carrying it, so a creator's own file — even one named like
// a master, sitting in a runtime/ folder — is provably never touched.
