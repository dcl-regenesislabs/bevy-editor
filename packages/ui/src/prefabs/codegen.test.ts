...
describe('the component table the registry hands the runtime', () => {
  ...
  it('is a contract with the runtime module the registry imports', () => {
    // the master itself — there is one shared copy per project and no carried ones
    const spawner = readPrefabFile('spawner.ts', new URL('../../../desktop/runtime-modules/', import.meta.url))
