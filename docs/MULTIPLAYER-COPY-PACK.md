...
| Game strip (Lagging **cut** per UX walk; Asleep merged: audit's noun + UX walk's verb) | "● Game running" / "◐ Waking… 12s" / "○ Game asleep — wakes when a player arrives." / "✕ Can't reach the Multiplayer Server — Logs" |
