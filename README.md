...
| **Leaderboard** | Under **Multiplayer Server** in the Prefabs tab: a board on a panel that keeps its scores across restarts. It carries a guide the AI assistant reads before writing anything that touches it. |
